...
<div class="sessions-view">
   ...
   <?php $user = Yii::$app->user->identity;
    ...
    <a class="btn btn-primary" href="/session-stagiaire/create?session_id=<?=$model->id?>">Ajouter un stagiaire</a>
    <ul>
        <?php
